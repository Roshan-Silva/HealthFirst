						...
						<div class="row">
							<div class="col-12">
								<div class="single-main">
									...
									<div class="meta">
										<div class="meta-left">
											<span class="author"><a href="#"><img src="{{ asset('frontend/img/author1.jpg') }}" alt="#">Naimur Rahman</a></span>
								...
								<div class="blog-comments">
									...
									<div class="comments-body">
										...
										<div class="single-comments">
											<div class="main">
												<div class="head">
													<img src="{{ asset('frontend/img/author1.jpg') }}" alt="#"/>
												</div>
												<div class="body">
													<h4>Afsana Mimi</h4>
										...
										<div class="single-comments left">
											<div class="main">
												<div class="head">
													<img src="{{ asset('frontend/img/author2.jpg') }}" alt="#"/>
												</div>
												<div class="body">
													<h4>Naimur Rahman</h4>
													<div class="comment-meta"><span class="meta"><i class="fa fa-calendar"></i>March 05, 2019</span><span class="meta"><i class="fa fa-clock-o"></i>03:38 AM</span></div>
										...
										<div class="single-comments">
											<div class="main">
												<div class="head">
													<img src="{{ asset('frontend/img/author3.jpg') }}" alt="#"/>
												</div>
												<div class="body">
							...
							<div class="col-12">
								<div class="comments-form">
									...
									<!-- Contact Form -->
									<form class="form" method="post" action="{{ asset('frontend/mail/mail.php') }}">
										<div class="row">
